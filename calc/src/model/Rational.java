...
public class Rational {
	 ...
	 * @param other Another Rational to substract to this.
	 * @return A new Rational representing the sum.
	 */
	 ...
	 * @throws Exception 
	 */
	public Rational div(Rational other) throws DivideException {
		
		if(other.denominator == 0.0 || other.numerator == 0.0){
			throw new DivideException(null);
		}
		else{
		return new Rational(
